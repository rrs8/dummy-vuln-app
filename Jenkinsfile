pipeline {
    ...
    stages {
        ...
        stage('Build Image') {
            steps {
                sh "sudo docker build --build-arg http_proxy=http://10.219.244.193:3128 --build-arg HTTP_PROXY=http://10.219.244.193:3128 -f Dockerfile -t ${params.DOCKER_REPOSITORY} ."
